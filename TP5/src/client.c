/* 16/10/2024 Fichier : client.c 
*Communication avec le fichier serveur.c pour afficher une chaine de caractère ou le résultat d'une opération
...
// envoi de l'opération à effectuer
int envoi_operateur_numeros(int socketfd) {
  char data[1024];
  memset(data, 0, sizeof(data));
  char message[100];
  printf("Saisir l'opération à effectuer : opérateur nombre1 nombre2 \n ");
...
int main()
{
  ...
  while (1)
  {
    ...
    // appel de la fonction pour le calcul 
    envoi_operateur_numeros(socketfd);
